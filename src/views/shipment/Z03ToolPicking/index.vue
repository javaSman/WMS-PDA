...
<script>
// Z03工具领料
const cachedName = 'shipment.Z03ToolPicking'
...
const passAPIName = '/exportGoodsBusiness/doPostZ03'
const listAPIName = '/exportGoodsBusiness/findListZ03'
export default {
  name: cachedName,
  components: {
    ToggleFormVue,
  ...
  methods: {
    ...
    authComfir() {
      this.$refs.ToggleFormRef.$refs.formComponent.$refs.imBarcode[0].$refs.inputRef.focus()
    }
  }
}
</script>
