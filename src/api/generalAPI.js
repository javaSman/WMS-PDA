// 通用API文件
import { requestWMS } from '@/utils/requestMes'
...
export const url_wms_wcf = process.env.VUE_APP_BASE_API_SAP // WMS业务_wcf部分测试
...
export const WMSAPI = commonAPI(url_wms, requestWMS) // WMS业务
export const WMSAPI_WCF = commonAPI(url_wms_wcf, requestWMS) // WMS业务_WCF
